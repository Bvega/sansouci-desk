        ...
        try {
            ...
            if($config_email && !empty($config_email['smtp_user'])){
                ...
                try {
                    ...
                    $mail->addAddress($config_email['smtp_from_email']); // Notificar a soporte
    ...
    <div class="card rounded-2xl shadow-2xl w-full max-w-6xl border border-blue-900">
        ...
        <div class="p-12">
                    ...
                    <div class="mt-12 border-t-4 border-green-300 pt-8">
                        ...
                        <form method="POST">
                            ...
                            <textarea name="respuesta" rows="6" required 
                                      class="w-full p-8 border-6 border-green-300 rounded-3xl text-2xl focus:border-green-600 transition resize-none shadow-xl"
                                      placeholder="Escribe tu respuesta aquí..."></textarea>
                            <div class="text-right mt-8">
                                <button type="submit" 
                                        class="bg-green-600 text-white px-20 py-10 rounded-full text-3xl font-bold hover:bg-green-700 shadow-3xl transform hover:scale-105 transition">
            ...
            <div class="mt-20 text-center">
                <a href="crear_ticket.php" class="bg-green-600 text-white px-24 py-12 rounded-full text-4xl font-bold hover:bg-green-700 shadow-3xl inline-block">
